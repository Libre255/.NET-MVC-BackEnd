...
namespace MVC_uppgift.Data
{
    public class ApplicationDbContext:DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            .HasData(new People { Id = 1, Name = "Tony montana", PhoneNumber = 24523421, CityId = 1, LanguageId = 1 });
            modelBuilder.Entity<People>()
            .HasData(new People { Id = 2, Name = "Werrever Tommorow", PhoneNumber = 345363234, CityId = 2, LanguageId = 2 });
            modelBuilder.Entity<People>()
            .HasData(new People { Id = 3, Name = "Lu Xiaojun", PhoneNumber = 43523413, CityId = 3, LanguageId = 3 });
            ...
            modelBuilder.Entity<PeopleLanguage>().HasKey(t => new { t.PeopleId, t.LanguageId });
